...
/// Firebase configuration for project daao-a20c6 (from Project Tracker Firebase Config).
/// Used for web; other platforms can add their options via FlutterFire CLI later.
